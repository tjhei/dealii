...
public:
  ...
  public:
     ...
     * If set to zero, default values provided by KINSOL will be used.
     */
    double maximum_newton_step = 0.0;
     ...
     */
    unsigned int maximum_beta_failures = 0;
     ...
     */
    unsigned int anderson_subspace_size = 0;
     ...
     */
    const double relative_tolerance = 1.e-5;
     ...
     */
    unsigned int threshold_n_linear_iterations = 1;
  ...
  : additional_data(additional_data)
{
  ...
  additional_data_kinsol.no_init_setup  = additional_data.no_init_setup;
  additional_data_kinsol.maximum_setup_calls =
    additional_data.maximum_setup_calls;
  additional_data_kinsol.maximum_newton_step =
    additional_data.maximum_newton_step;
  additional_data_kinsol.dq_relative_error = additional_data.dq_relative_error;
  additional_data_kinsol.maximum_beta_failures =
    additional_data.maximum_beta_failures;
...
// Do the same thing we did above but with NOX
  ...
  additional_data_nox.threshold_n_linear_iterations =
    additional_data.threshold_n_linear_iterations;
  additional_data_nox.reuse_solver = additional_data.reuse_solver;
#endif
}
