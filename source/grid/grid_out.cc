...
template <int dim, int spacedim>
void GridOut::write_debug_vtu_per_processor (const Triangulation<dim,spacedim> &tria,
  ...
  if (tria.locally_owned_subdomain() == 0)
    {
      ...
      //We need at a dummy vector with the names of the data values in the .vtu files
      ...
      data_out.add_data_vector (dummy_vector, "lvlsubdomain");
